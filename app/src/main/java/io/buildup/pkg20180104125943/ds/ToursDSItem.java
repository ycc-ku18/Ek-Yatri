...
public class ToursDSItem implements Parcelable, IdentifiableBean {
    ...
    public static final Creator<ToursDSItem> CREATOR = new Creator<ToursDSItem>() {
        @Override
        public ToursDSItem createFromParcel(Parcel in) {
            ToursDSItem item = new ToursDSItem();
        ...
        @Override
        public ToursDSItem[] newArray(int size) {
            return new ToursDSItem[size];
        }
    };
