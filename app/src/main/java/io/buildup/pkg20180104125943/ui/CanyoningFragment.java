...
/**
 * "CanyoningFragment" listing
 */
public class CanyoningFragment extends ListGridFragment<Item>  {

    private Datasource<Item> datasource;


    public static CanyoningFragment newInstance(Bundle args) {
        CanyoningFragment fr = new CanyoningFragment();
    ...
    */
    ...
    protected int getItemLayout() {
        return R.layout.canyoning_item;
    }
