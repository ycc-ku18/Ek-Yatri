...
/**
 * "ZipliningFragment" listing
 */
public class ZipliningFragment extends ListGridFragment<Item>  {

    private Datasource<Item> datasource;


    public static ZipliningFragment newInstance(Bundle args) {
        ZipliningFragment fr = new ZipliningFragment();
    ...
    */
    ...
    protected int getItemLayout() {
        return R.layout.ziplining_item;
    }
