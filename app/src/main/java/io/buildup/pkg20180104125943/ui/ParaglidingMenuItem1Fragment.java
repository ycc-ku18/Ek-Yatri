...
/**
 * "ParaglidingMenuItem1Fragment" listing
 */
public class ParaglidingMenuItem1Fragment extends ListGridFragment<ProductsDSItem>  {
    ...
    public static ParaglidingMenuItem1Fragment newInstance(Bundle args) {
        ParaglidingMenuItem1Fragment fr = new ParaglidingMenuItem1Fragment();
    ...
    */
    ...
    protected int getItemLayout() {
        return R.layout.paraglidingmenuitem1_item;
    }
    ...
    public void showDetail(ProductsDSItem item, int position) {
        Intent intent = generateIntentToDetailOrForm(item,
            position,
            getActivity(),
            ParaglidingMenuItem1DetailActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() == R.id.filter){
            Intent intent = new Intent(getActivity(), ParaglidingMenuItem1FilterActivity.class);
