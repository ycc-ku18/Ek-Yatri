...
/**
 * "RaftingMenuItem1Fragment" listing
 */
public class RaftingMenuItem1Fragment extends ListGridFragment<ProductsDSItem>  {
    ...
    public static RaftingMenuItem1Fragment newInstance(Bundle args) {
        RaftingMenuItem1Fragment fr = new RaftingMenuItem1Fragment();
    ...
    */
    ...
    protected int getItemLayout() {
        return R.layout.raftingmenuitem1_item;
    }
    ...
    public void showDetail(ProductsDSItem item, int position) {
        Intent intent = generateIntentToDetailOrForm(item,
            position,
            getActivity(),
            RaftingMenuItem1DetailActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() == R.id.filter){
            Intent intent = new Intent(getActivity(), RaftingMenuItem1FilterActivity.class);
