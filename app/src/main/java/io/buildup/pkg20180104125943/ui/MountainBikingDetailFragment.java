...
public class MountainBikingDetailFragment extends buildup.ui.DetailFragment<ProductsDSItem> implements ShareBehavior.ShareListener {

    private Datasource<ProductsDSItem> datasource;
    public static MountainBikingDetailFragment newInstance(Bundle args){
        MountainBikingDetailFragment fr = new MountainBikingDetailFragment();
        fr.setArguments(args);

        return fr;
    }

    public MountainBikingDetailFragment(){
        super();
    }
    ...
    protected int getLayout() {
        return R.layout.mountainbikingdetail_detail;
    }
