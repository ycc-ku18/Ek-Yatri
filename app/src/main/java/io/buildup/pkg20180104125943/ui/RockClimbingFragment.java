...
/**
 * "RockClimbingFragment" listing
 */
public class RockClimbingFragment extends ListGridFragment<Item>  {

    private Datasource<Item> datasource;


    public static RockClimbingFragment newInstance(Bundle args) {
        RockClimbingFragment fr = new RockClimbingFragment();
    ...
    */
    ...
    protected int getItemLayout() {
        return R.layout.rockclimbing_item;
    }
