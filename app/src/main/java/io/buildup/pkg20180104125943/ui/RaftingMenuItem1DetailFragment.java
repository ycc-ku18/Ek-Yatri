...
public class RaftingMenuItem1DetailFragment extends buildup.ui.DetailFragment<ProductsDSItem> implements ShareBehavior.ShareListener {

    private Datasource<ProductsDSItem> datasource;
    public static RaftingMenuItem1DetailFragment newInstance(Bundle args){
        RaftingMenuItem1DetailFragment fr = new RaftingMenuItem1DetailFragment();
        fr.setArguments(args);

        return fr;
    }

    public RaftingMenuItem1DetailFragment(){
        super();
    }
    ...
    protected int getLayout() {
        return R.layout.raftingmenuitem1detail_detail;
    }
