...
public class GeoPicker extends LinearLayout {
    ...
    public GeoPicker(final Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        myLocationBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              if (loc != null) {
                  ...
                  Snackbar.make(v, context.getString(R.string.error_location_unavailable), Snackbar.LENGTH_SHORT).show();
              }
            }
         }
        );
