...
public abstract class FormFragment<T>
    ...
    public void bindBoolean(int viewId, Boolean value, Boolean readonly, View.OnClickListener listener){
    ...
    public void bindNullableBoolean(int viewId, Boolean value, Boolean readonly, TristateBooleanPicker.ChoiceListener listener){
    ...
    public void bindLong(int viewId, Long value, Boolean readonly, TextWatcher listener, Validator<T> validator){
        ...
        bindString(viewId, strVal, readonly, listener, validator);
    }
    ...
    public void bindDatePicker(int viewId, Date value, Boolean readonly, DatePicker.DateSelectedListener listener){
        bindDatePicker(viewId, value, readonly, listener, null);
    }

    public void bindDatePicker(int viewId, Date value, Boolean readonly, DatePicker.DateSelectedListener listener, Validator<T> validator){
    ...
    public void bindImage(int viewId, URL value, Boolean readonly, int index, ImagePicker.Callback callback) {
        this.bindImage(viewId, value, readonly, index, null, callback);
    }

    public void bindImage(int viewId, URL value, Boolean readonly, int index, Validator<T> validator, ImagePicker.Callback callback){
        ImagePicker picker = (ImagePicker) getView().findViewById(viewId);
        picker.setTargetFragment(this);
        picker.setEnabled(readonly);
        if(callback != null)
    ...
    public void bindLocation(int viewId, GeoPoint value, Boolean readonly, GeoPicker.PointChangedListener listener){
        bindLocation(viewId, value, readonly, listener, null);
    }

    public void bindLocation(int viewId, GeoPoint value, Boolean readonly, GeoPicker.PointChangedListener listener, Validator<T> validator){
