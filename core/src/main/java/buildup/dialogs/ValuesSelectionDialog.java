            ...
            datasource.getUniqueValuesFor(columnName,
                    new Datasource.Listener<List<String>>() {
                        ...
                        public void onSuccess(List<String> objects) {
                            adapter.clear();
                            adapter.addAll(new ArrayList<>(StringUtils.replaceNullOrEmptyByText(objects)));
                        }
    ...
    private void createAdapter() {
        adapter = new ArrayAdapter<String>(
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                if(value.equals(getString(R.string.select_empty))) {
                    value = "";
                }
        ...
        if (!canceled && selectionListener != null) {
            ...
            for (int i = 0; i < checked.size(); i++) {
                if (checked.valueAt(i)) {
                    ...
                    if(item.equals(getString(R.string.select_empty))) {
                        item = "";
                    }
